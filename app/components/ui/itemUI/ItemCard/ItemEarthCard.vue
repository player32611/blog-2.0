...
const createItem = (x: number, y: number, angle: number): Body | null => {
	...
	return Bodies.circle(x, y, itemRef.value.offsetHeight / 2, {
		angle,
		restitution: 0.6,
		friction: 0.5,
		render: {
...
@media screen and (max-width: 576px) {
	...
	.item_earth {
		...
		.section_banner {
			...
			box-shadow:
				0px 0 20px * $base-size RGBA(255, 255, 255, 0.2),
				-5px * $base-size 0px 8px * $base-size #c3f4ff inset,
				15px * $base-size 2px * $base-size 25px * $base-size #000 inset,
				-24px * $base-size -2px * $base-size 34px * $base-size #c3f4ff99 inset,
				250px * $base-size 0px 44px * $base-size #00000066 inset,
				150px * $base-size 0px 38px * $base-size #000000aa inset;
		}
	}
	...
	@keyframes earthRotate {
		...
		100% {
			background-position: 400px * $base-size 0;
		}
	}
}

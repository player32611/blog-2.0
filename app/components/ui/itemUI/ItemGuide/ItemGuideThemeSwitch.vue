...
const inputValue = computed({
	get: () => itemStore.backgroundTheme === "dark",
	set: newValue => {
		itemStore.backgroundTheme = newValue ? "dark" : "light";
	},
});
</script>
...
<template>
	...
	<label class="theme-switch">
		<input class="theme-switch__checkbox" type="checkbox" ref="inputRef" v-model="inputValue" />
...
.theme-switch__sun-moon-container {
	...
	filter: url(#sketchy-sm) drop-shadow(0.062em 0.125em 0.125em rgba(0, 0, 0, 0.25))

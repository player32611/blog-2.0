	...
	.sign {
		...
		.sign_head {
			...
			.sign_content {
				...
				width: calc(100% - 10px * 2 * $base-size);
		...
		.sign {
			.sign_head {
				...
				.leaf_1 {
					...
					filter: drop-shadow(
						2px * $base-size 2px * $base-size 3px * $base-size rgba(0, 0, 0, 0.3)
					);
					rotate: 180deg;
				}
				...
				.leaf_2 {
					...
					filter: drop-shadow(
						2px * $base-size 2px * $base-size 3px * $base-size rgba(0, 0, 0, 0.5)
					);
					rotate: 180deg;
				}
